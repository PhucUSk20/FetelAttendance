...
public class CustomClassListAdapterForCommon extends ArrayAdapter<String> {
    ...
    public CustomClassListAdapterForCommon(Context context, ArrayList<String> classList, ArrayList<Integer> backgroundList, ArrayList<Integer> studentCountList) {
