...
public class AttendListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        filejson = new File("/storage/self/primary/Download"+"/"+selectedDate+".json");
        ...
        exportjson.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Toast.makeText(AttendListActivity.this,"Export Json Success",Toast.LENGTH_SHORT).show();
                }catch (Exception e){
                    e.printStackTrace();
                    Toast.makeText(AttendListActivity.this,"Error exporting to JSON",Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private class DatabaseTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            if (connection != null) {
                try {
                    String query = "SELECT name_student, code_student, date_of_birth, attendance_date, classId FROM ATTENDANCE WHERE attendance_date = ? AND classId = (SELECT id FROM CLASS WHERE name_subject = ?)";
